...
class IsbnSpec extends ObjectBehavior
{
    ...
    {
        $this
            ->shouldThrow(new \InvalidArgumentException('ISBN number cannot be an empty string!'))
            ->during('__construct', array(''))
        ;
    }

    function it_has_to_respect_isbn13_standard()
    {
        $this
            ->shouldThrow(new \InvalidArgumentException('This is not a valid ISBN number.'))
            ->during('__construct', array('12345'))
        ;
    }
